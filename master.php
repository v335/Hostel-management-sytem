        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-money fa-fw"></i>Admin Students Payment <span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
					  ...
					  <li>
                        <a href="#"><i class="fa fa-money fa-fw"></i>Students Personal  Payment<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                           
                            

                            <li>
                                <a href="<?php echo $base_url.'ui/student/view.php'?>">View</a>
                            </li>
                    ...
                    <li>
                        <a href="#"><i class="fa fa-money fa-fw"></i>Bookings<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                        <li>
                                <a href="<?php echo $base_url.'ui/stdbooking/view.php'?>">View Bookings</a>
                        </li>
