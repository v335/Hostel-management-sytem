        ...
        <ul class="nav navbar-top-links navbar-right">
            ...
            <li class="dropdown">
                <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                    <i class="fa fa-bars fa-fw"></i>Student Menu <i class="fa fa-caret-down"></i>
                </a>
                <ul class="dropdown-menu dropdown-user">
                    <li><a href="<?php echo $base_url;?>ui/usr/profile.php"><i class="fa fa-user fa-fw"></i> User Profile</a>
                    </li>
                    <li>
                    <a href="<?php echo $base_url.'ui/stdbooking/add.php'?>"><i class="fa fa-money fa-fw"></i> Book Hostel</a>
                   </li> 
                   <li>
                    <a href="<?php echo $base_url.'ui/stdbooking/view.php'?>"><i class="fa fa-money fa-fw"></i> Room details</a>
                   </li> 
                    <li>
